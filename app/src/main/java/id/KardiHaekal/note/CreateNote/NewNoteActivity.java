package id.KardiHaekal.note.CreateNote;
...
public class NewNoteActivity extends AppCompatActivity {
    ...
    btnCreate.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View view) {
        ...
        if (!TextUtils.isEmpty(title) && !TextUtils.isEmpty(content)) {
          ...
          Snackbar.make(view, "diisi yang masih kosong", Snackbar.LENGTH_SHORT).show();
        }
  ...
  private void createNote(String title, String content) {
    ...
    if (fAuth.getCurrentUser() != null) {
      ...
      if (isExist) {
        ...
        Toast.makeText(this, "Note di update", Toast.LENGTH_SHORT).show();
      } else {
        // CREATE A NEW NOTE
            ...
            newNoteRef.setValue(noteMap).addOnCompleteListener(new OnCompleteListener<Void>() {
              ...
              public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()) {
                  Toast.makeText(NewNoteActivity.this, "Note berhasil di tambahkan ke Database", Toast.LENGTH_SHORT).show();
                } else {
      ...
      Toast.makeText(this, "PENGGUNA BELUM SIGN IN", Toast.LENGTH_SHORT).show();
    }
    ...
    switch (item.getItemId()) {
      ...
      case R.id.new_note_delete_btn:
        if (isExist) {
          ...
          Toast.makeText(this, "Tidak ada yang dihapus", Toast.LENGTH_SHORT).show();
        }
        break;
    }
  ...
  private void deleteNote() {
    ...
    fNotesDatabase.child(noteID).removeValue().addOnCompleteListener(new OnCompleteListener<Void>() {
      ...
      public void onComplete(@NonNull Task<Void> task) {
        if (task.isSuccessful()) {
          Toast.makeText(NewNoteActivity.this, "Note dihapus", Toast.LENGTH_SHORT).show();
          noteID = "no";
          finish();
        } else {
